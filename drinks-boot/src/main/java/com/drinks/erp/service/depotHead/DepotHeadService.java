package com.drinks.erp.service.depotHead;

import com.alibaba.fastjson.JSONObject;
import com.drinks.erp.constants.BusinessConstants;
import com.drinks.erp.constants.ExceptionConstants;
import com.drinks.erp.datasource.entities.*;
import com.drinks.erp.datasource.mappers.DepotHeadMapper;
import com.drinks.erp.datasource.mappers.DepotHeadMapperEx;
import com.drinks.erp.datasource.mappers.DepotItemMapperEx;
import com.drinks.erp.datasource.vo.DepotHeadVo4InDetail;
import com.drinks.erp.datasource.vo.DepotHeadVo4InOutMCount;
import com.drinks.erp.datasource.vo.DepotHeadVo4List;
import com.drinks.erp.datasource.vo.DepotHeadVo4StatementAccount;
import com.drinks.erp.exception.BusinessRunTimeException;
import com.drinks.erp.exception.JshException;
import com.drinks.erp.service.accountHead.AccountHeadService;
import com.drinks.erp.service.accountItem.AccountItemService;
import com.drinks.erp.service.depot.DepotService;
import com.drinks.erp.service.depotItem.DepotItemService;
import com.drinks.erp.service.log.LogService;
import com.drinks.erp.service.orgaUserRel.OrgaUserRelService;
import com.drinks.erp.service.person.PersonService;
import com.drinks.erp.service.role.RoleService;
import com.drinks.erp.service.serialNumber.SerialNumberService;
import com.drinks.erp.service.supplier.SupplierService;
import com.drinks.erp.service.systemConfig.SystemConfigService;
import com.drinks.erp.service.user.UserService;
import com.drinks.erp.service.userBusiness.UserBusinessService;
import com.drinks.erp.utils.StringUtil;
import com.drinks.erp.utils.Tools;
import com.drinks.erp.datasource.entities.*;
import com.drinks.erp.service.account.AccountService;
