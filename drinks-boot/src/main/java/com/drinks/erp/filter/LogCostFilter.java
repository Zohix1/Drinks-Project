...
@WebFilter(filterName = "LogCostFilter", urlPatterns = {"/*"},
        initParams = {@WebInitParam(name = "ignoredUrl", value = ".ico"),
                      @WebInitParam(name = "filterPath",
                              value = "/drinks-boot/user/login#/drinks-boot/user/registerUser#/drinks-boot/user/randomImage#" +
                                      "/drinks-boot/platformConfig/getPlatform#/drinks-boot/v2/api-docs#/drinks-boot/webjars#" +
                                      "/drinks-boot/systemConfig/static")})
