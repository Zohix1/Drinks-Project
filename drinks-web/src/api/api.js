...
const editPlatformConfig = (params)=>postAction("/platformConfig/updatePlatformConfigByKey",params);
const getPlatformConfigByKey = (params)=>getAction("/platformConfig/getPlatformConfigByKey",params);
const getPlatformConfig = (type,params)=>getAction("/platformConfig/getPlatform/"+type,params);
//用户|角色|模块关系
